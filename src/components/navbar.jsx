      ...
      <nav className="navbar navbar-expand-lg bg-danger shadow">
        <div className="container-fluid">
          <ul className="col-12 d-flex justify-content-evenly">
            <li className="nav-item "><NavLink to='/' className='nav-link text-light'><i className="fa-solid fa-home"></i></NavLink></li>
            <li className="nav-item "><NavLink to='/' className='nav-link text-light'><i className="fa-solid fa-right-from-bracket"></i></NavLink></li>
